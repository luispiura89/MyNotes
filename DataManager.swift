...
class DataManager: NSObject {
    ...
    static func getDataForClass(className : String, request : NSFetchRequest) -> [AnyObject]! {
    ...
    private static var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.eduardo.Core_Data" in the application's documents Application Support directory.
    ...
    static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Notes_Data", withExtension: "momd")!
